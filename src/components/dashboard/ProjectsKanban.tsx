    ...
    return (
      <div className="glass-card border border-white/[0.06] rounded-xl overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center h-[200px] text-center px-4">
          ...
          <p className="font-mono-data text-[11px] text-white/30">No deliverables found</p>
          <p className="font-mono-data text-[10px] text-white/15 mt-1">Create deliverables to see them here in Kanban view</p>
        </div>
      </div>
    );
  }
